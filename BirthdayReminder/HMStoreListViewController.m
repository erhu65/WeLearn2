...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([product.info.icon length] > 0) {
        ...
        [cell.iconImageView setImageWithRemoteFileURL:picUrl placeHolderImage:[UIImage imageNamed:@"icon-birthday-cake.png"]];
    }  else cell.iconImageView.image = [UIImage imageNamed:@"icon-birthday-cake.png"];
