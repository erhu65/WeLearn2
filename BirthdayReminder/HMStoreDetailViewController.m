...
- (void)refresh {
    ...
    if ([_product.info.icon length] > 0) {
        ...
        [self.imvBg setImageWithRemoteFileURL:picUrl placeHolderImage:[UIImage imageNamed:@"icon-birthday-cake.png"]];
    }  else  self.imvBg.image = [UIImage imageNamed:@"icon-birthday-cake.png"];
